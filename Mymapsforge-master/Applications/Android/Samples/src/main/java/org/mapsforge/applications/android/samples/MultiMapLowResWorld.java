...
public class MultiMapLowResWorld extends RenderTheme4 {
	...
	protected MapDataStore getMapFile1() {
		...
		return new MapFile(new File(Environment.getExternalStorageDirectory(), "rhone-alpes.map"));
	}
	...
	protected MapDataStore getMapFile2() {
		return new MapFile(new File(Environment.getExternalStorageDirectory(), "provence-alpes-cote-d-azur.map"));
	...
	public static File getWorldMapFile(Context context) {
		return new File(Environment.getExternalStorageDirectory(), "provence.map");
